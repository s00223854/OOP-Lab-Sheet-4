...
namespace Ex4
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Total items in all registors: {0}", CashRegister.totalAllItemsRegs);
            Console.WriteLine("Total cash in all registors: {0}", CashRegister.totalAllMoneyRegs);

            //Console.WriteLine("Total items in all registors: {0}", reg1.items + reg2.items);
            //Console.WriteLine("Total cash in all registors: {0}", reg1.total + reg2.total);
        }
    }
}
